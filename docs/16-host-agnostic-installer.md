...
三段全程可由目标机 AI agent 代跑：人机分工协议与 kickoff 提示词见 docs/17（agent 执行一切可执行项，人工仅处理提权/GUI/登录/key/决策/hooks 注册；宪法 AGENTS.md 在安装窗口内由 agent 问答渲染、人复核——17 §3 S5；安全铁律见 17 §3——hooks 注册人闸对齐 05 §3，key 不落盘对齐本文 §5）。
